...
(cl:defmethod cl:initialize-instance :after ((m <Msg_SensorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Msg_SensorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aiguillages-msg:<Msg_SensorState> is deprecated: use aiguillages-msg:Msg_SensorState instead.")))
...
(cl:defmethod CPI-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aiguillages-msg:CPI-val is deprecated.  Use aiguillages-msg:CPI instead.")
  (CPI m))

(cl:ensure-generic-function 'CP-val :lambda-list '(m))
(cl:defmethod CP-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aiguillages-msg:CP-val is deprecated.  Use aiguillages-msg:CP instead.")
  (CP m))

(cl:ensure-generic-function 'PS-val :lambda-list '(m))
(cl:defmethod PS-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aiguillages-msg:PS-val is deprecated.  Use aiguillages-msg:PS instead.")
  (PS m))

(cl:ensure-generic-function 'DG-val :lambda-list '(m))
(cl:defmethod DG-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aiguillages-msg:DG-val is deprecated.  Use aiguillages-msg:DG instead.")
  (DG m))

(cl:ensure-generic-function 'DD-val :lambda-list '(m))
(cl:defmethod DD-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aiguillages-msg:DD-val is deprecated.  Use aiguillages-msg:DD instead.")
  (DD m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Msg_SensorState>)))
  ...
  "5e5483b92cc5dad298967591bceb2081")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Msg_SensorState)))
  "Returns md5sum for a message object of type 'Msg_SensorState"
  "5e5483b92cc5dad298967591bceb2081")
